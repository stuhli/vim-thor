...
syn match ThorImportant 'Keyword found in registry hive entries'
syn match ThorImportant 'Malware file found'
syn match ThorImportant 'Malware filename in Log Entry found'
syn match ThorImportant 'Malware file name in Log Entry found'
syn match ThorImportant 'Malware file name in process handle found'
syn match ThorImportant 'Malware file name in registry entry found'
syn match ThorImportant 'Malware file name in service found'
syn match ThorImportant 'Malware file name in service key found'
syn match ThorImportant 'Possibly Dangerous file found'
syn match ThorImportant 'critical Sigma match on eventlog entry'
...
syn match ThorImportant 'Could not read sigma config'
syn match ThorImportant 'Effective argument [Ll]ist: \[.*\]'
...
syn match ThorImportant "No rules with DEEPSCAN tag found. THOR won't scan any files with YARA rules. Please ensure that you use up-to-date signatures."
syn match ThorImportant 'No valid license file found'
syn match ThorImportant 'Process with high memory usage'
syn match ThorImportant 'Quick Scan Mode'
...
syn match ThorImportant "Skip sigma initialization, use '--sigma' flag to scan with sigma"
...
syn match ThorImportant 'Signature Database:  \zeSCANID'
syn match ThorImportant "Signature file is older than \d\{1,3} days. Run 'thor-util upgrade' to get new signatures."
syn match ThorImportant 'Some modules and features are not available in Lite version and will be disabled'
...
syn match ThorImportant 'This THOR Lite license permits .* \zeSCANID'
syn match ThorImportant "THOR should be started 'As Administrator' to have full access to files, process memory and the security eventlog"
...
syn match ThorModule 'MODULE: EtwWatcher'
...
syn match ThorModule 'MODULE: Integritycheck'
...
syn match ThorModule 'MODULE: MFT'
...
syn match ThorMessage 'MESSAGE: Activating soft mode due to total memory lower than 1024 MB, use --nosoft to prevent this'
syn match ThorMessage 'MESSAGE: Adding \d\+ malware domains to yara process memory and log scans'
...
syn match ThorMessage 'MESSAGE: And \d\+ more invalid License files found, use --printlicenses to print all licenses'
...
syn match ThorMessage 'MESSAGE: Autoruns element with dangerous permissions on executable (everyone has write access to that element)'
syn match ThorMessage 'MESSAGE: Autoruns element with tolerant permissions on excutable (a user group has write access to that element)'
...
syn match ThorMessage 'MESSAGE: Checking for drovorub rootkit'
...
syn match ThorMessage 'MESSAGE: Configuration file in package failed verification'
syn match ThorMessage 'MESSAGE: Connection output threshold reached. Output truncated.'
syn match ThorMessage 'MESSAGE: Corrupt /etc/passwd entry, skipping entry'
syn match ThorMessage 'MESSAGE: Could not call netsh for firewall checks'
syn match ThorMessage 'MESSAGE: Could not check integrity: no supported package manager found'
syn match ThorMessage 'MESSAGE: Could not check integrity: no supported package manager was found'
syn match ThorMessage 'MESSAGE: Could not get available physical memory, disabling resource checks'
syn match ThorMessage 'MESSAGE: Could not get files of directory'
syn match ThorMessage 'MESSAGE: Could not get ip adresses'
syn match ThorMessage 'MESSAGE: Could not get logged in users'
syn match ThorMessage 'MESSAGE: Could not get open files'
syn match ThorMessage 'MESSAGE: Could not get process connections of process'
syn match ThorMessage 'MESSAGE: Could not get user profiles'
syn match ThorMessage 'MESSAGE: Could not init syslog target'
syn match ThorMessage 'MESSAGE: Could not list network sessions'
syn match ThorMessage 'MESSAGE: Could not list network shares'
syn match ThorMessage 'MESSAGE: Could not open Eventlog \S\+'
syn match ThorMessage 'MESSAGE: Could not parse evtx chunk'
syn match ThorMessage 'MESSAGE: Could not parse license'
...
syn match ThorMessage 'MESSAGE: Could not remove lock file'
syn match ThorMessage 'MESSAGE: Could not scan file with yara'
syn match ThorMessage 'MESSAGE: Could not send file to bifrost server'
syn match ThorMessage 'MESSAGE: Could not write console output'
syn match ThorMessage "MESSAGE: Couldn't find any \S\+"
syn match ThorMessage 'MESSAGE: CPU Count: \d\+'
syn match ThorMessage 'MESSAGE: Crontab entry'
syn match ThorMessage 'MESSAGE: Crontab environment setting'
...
syn match ThorMessage 'MESSAGE: Disabling feature \w\+ due to Lite version'
syn match ThorMessage 'MESSAGE: Disabling module \w\+ due to Lite version'
...
syn match ThorMessage 'MESSAGE: Error Report - Found AppCrash in uncommon folder'
...
syn match ThorMessage 'MESSAGE: Error Report - Found Critical in uncommon folder'
...
syn match ThorMessage 'MESSAGE: Evil Event ID'
syn match ThorMessage 'MESSAGE: Evil service'
...
syn match ThorMessage 'MESSAGE: File in package failed verification'
syn match ThorMessage 'MESSAGE: File regularly executed by cron'
syn match ThorMessage 'MESSAGE: File was possibly timestomped'
syn match ThorMessage 'MESSAGE: Filename IOC matched on app crash dump'
...
syn match ThorMessage 'MESSAGE: Firewall is not configured with iptables or nft'
...
syn match ThorMessage 'MESSAGE: Found entry in suspicious directory'
syn match ThorMessage 'MESSAGE: Found entry in suspicious directory (indicates a \w\+ execution at a given date)'
syn match ThorMessage 'MESSAGE: Found public key that has SSH access'
...
syn match ThorMessage 'MESSAGE: IP forwarding is enabled'
...
syn match ThorMessage 'MESSAGE: Language: .* \zeSCANID'
...
syn match ThorMessage 'MESSAGE: Listing of Unit Files Failed'
syn match ThorMessage 'MESSAGE: Logged more than 0 MB, switching to reduced logging'
syn match ThorMessage 'MESSAGE: Logged more than 64 MB, exiting THOR to prevent log flooding due to a high number of false positives'
...
syn match ThorMessage 'MESSAGE: malicious named pipe found'
...
syn match ThorMessage 'MESSAGE: Netbios Domain: \S\+'
syn match ThorMessage 'MESSAGE: Network share is freely writable from the outside'
syn match ThorMessage 'MESSAGE: New Hash value for Service. Service has changed since last run'
syn match ThorMessage 'MESSAGE: NFTables is configured to accept any traffic that is not explicitly dropped'
syn match ThorMessage 'MESSAGE: No csv report file will be written'
syn match ThorMessage 'MESSAGE: No custom \w\+ excludes defined'
syn match ThorMessage 'MESSAGE: No debugger registered for .* that is good'
syn match ThorMessage "MESSAGE: No file type signatures compiled, file type detection can't be done. Because of this, many files won't be scanned."
...
syn match ThorMessage 'MESSAGE: Notable file name in Log Entry found'
syn match ThorMessage 'MESSAGE: Notable service found'
...
syn match ThorMessage 'MESSAGE: Noteworthy Event ID'
syn match ThorMessage 'MESSAGE: Noteworthy file name in Amcache entry found'
syn match ThorMessage 'MESSAGE: Noteworthy file name in eventlog entry found'
syn match ThorMessage 'MESSAGE: Noteworthy file name in link file found'
syn match ThorMessage 'MESSAGE: Noteworthy file name in Log Entry found'
syn match ThorMessage 'MESSAGE: Noteworthy file name in mft record found'
syn match ThorMessage 'MESSAGE: Noteworthy file name in registry entry found'
syn match ThorMessage 'MESSAGE: Noteworthy file name in registry hive entries found'
syn match ThorMessage 'MESSAGE: Noteworthy file name in Shellbag entry found'
syn match ThorMessage 'MESSAGE: Noteworthy file name in SHIM Cache found'
syn match ThorMessage 'MESSAGE: Noteworthy startup element WMI Run Key Evaluation'
syn match ThorMessage 'MESSAGE: Noteworthy startup program WMI Run Key Evaluation'
...
syn match ThorMessage 'MESSAGE: Panic when checking file'
syn match ThorMessage 'MESSAGE: Platform DeepEval'
syn match ThorMessage 'MESSAGE: Platform: .* \zeSCANID'
syn match ThorMessage 'MESSAGE: Process info'
syn match ThorMessage 'MESSAGE: Process started from suspicious location'
syn match ThorMessage 'MESSAGE: Rare process start (<\d executions) in suspicious location'
syn match ThorMessage 'MESSAGE: Rare process start (<\d executions) on the system'
syn match ThorMessage 'MESSAGE: Reading iocs from .* as .* type'
syn match ThorMessage 'MESSAGE: Received shutdown signal, exiting.'
...
syn match ThorMessage 'MESSAGE: Rule triggered more than 10 times in the current element. Future matches will be suppressed. To show all matches use --showall.'
...
syn match ThorMessage 'MESSAGE: Scheduled Task with non existing binary'
...
syn match ThorMessage 'MESSAGE: Service executable is not owned by root group and group writable'
syn match ThorMessage 'MESSAGE: Service seems to be vulnerable to privilege escalation - unquoted service paths'
syn match ThorMessage 'MESSAGE: Service started from suspected attacker location'
syn match ThorMessage 'MESSAGE: Service that is not owned by root user'
syn match ThorMessage 'MESSAGE: Service with dangerous permissions on executable (everyone has write access to the service binary)'
syn match ThorMessage 'MESSAGE: Service with rare permissions on executable'
syn match ThorMessage 'MESSAGE: Service with tolerant permissions on excutable (a user group has write access to the service binary)'
syn match ThorMessage 'MESSAGE: Service with tolerant permissions on executable (a user group has write access to the service binary)'
...
syn match ThorMessage 'MESSAGE: Sigma match on eventlog entry'
syn match ThorMessage 'MESSAGE: Sigma match on Eventlog record'
syn match ThorMessage 'MESSAGE: Sigma match on process'
syn match ThorMessage 'MESSAGE: Sigma rule matched on log line'
...
syn match ThorMessage 'MESSAGE: Skipping log lines and eventlogs which were modified before \w\{3} \w\{3} \s\{0,1}\d\{1,2} \d\{2}:\d\{2}:\d\{2} \d\{4}'
...
syn match ThorMessage 'MESSAGE: Started background task to detect CobaltStrike beacon activity'
syn match ThorMessage 'MESSAGE: Starting module'
syn match ThorMessage 'MESSAGE: Startup Element'
syn match ThorMessage 'MESSAGE: Stopped background task to detect CobaltStrike beacon activity'
syn match ThorMessage 'MESSAGE: Stopping log scan due to increasing file size'
syn match ThorMessage 'MESSAGE: Storing current position for resume. Use --resume in addition to the current command line options to resume later.'
...
syn match ThorMessage 'MESSAGE: Successfully sent file to bifrost server'
syn match ThorMessage 'MESSAGE: Suspicious archived file found'
syn match ThorMessage 'MESSAGE: Suspicious entry found in Hosts file'
...
syn match ThorMessage 'MESSAGE: Suspicious file name in process found'
...
syn match ThorMessage 'MESSAGE: Suspicious file name in scheduled task found'
...
syn match ThorMessage 'MESSAGE: Suspicious file name in TAR detected'
...
syn match ThorMessage 'MESSAGE: Suspicious Local Port defined in Firewall rule'
syn match ThorMessage 'MESSAGE: Suspicious logged in user name'
syn match ThorMessage 'MESSAGE: suspicious named pipe found'
syn match ThorMessage 'MESSAGE: Suspicious service found'
syn match ThorMessage 'MESSAGE: Suspicious Service Type Combiation'
syn match ThorMessage 'MESSAGE: Suspicious Service Type Combination'
syn match ThorMessage 'MESSAGE: Suspicious thread created file'
syn match ThorMessage 'MESSAGE: Suspicious thread regularly called to server'
...
syn match ThorMessage 'MESSAGE: Suspicious WMI element'
...
syn match ThorMessage 'MESSAGE: TaskScheduler is not supported in THOR legacy'
syn match ThorMessage 'MESSAGE: The following paths will be scanned: .* \zeSCANID'
syn match ThorMessage 'MESSAGE: Thor Build: .* \zeSCANID'
syn match ThorMessage 'MESSAGE: Thor Scan started'
syn match ThorMessage 'MESSAGE: Thor Version: .* \zeSCANID'
syn match ThorMessage 'MESSAGE: Thread regularly called to server'
...
syn match ThorMessage 'MESSAGE: User has an empty password'
syn match ThorMessage 'MESSAGE: User in /etc/shadow, but not in /etc/passwd file'
syn match ThorMessage 'MESSAGE: User is disabled with active crontab jobs'
syn match ThorMessage 'MESSAGE: User is disabled with non-empty access file'
syn match ThorMessage 'MESSAGE: User uses a deprecated password hash of type md5crypt'
syn match ThorMessage "MESSAGE: WDigest as 'UseLogonCredential' set to '1', which allows clear text credential dumping"
...
syn match ThorMessage 'MESSAGE: Writing syslog to: \S\+ (format: \w\+)'
syn match ThorMessage 'MESSAGE: YARA Rule Match in AtJob'
...
syn match ThorMessage 'MESSAGE: YARA Rule Match in process'
...
syn match ThorMessage 'MESSAGE: YARA Rule Match in service'
...
syn match ThorBodyInlineField '$\{0,1}Action ID:'
syn match ThorBodyInlineField '$\{0,1}Action Name:'
syn match ThorBodyInlineField '$\{0,1}ActionName:'
syn match ThorBodyInlineField '$\{0,1}Additional Actions ID:'
syn match ThorBodyInlineField '$\{0,1}Additional Actions String:'
...
syn match ThorBodyInlineField '$\{0,1}Category ID:'
syn match ThorBodyInlineField '$\{0,1}Category Name:'
syn match ThorBodyInlineField '$\{0,1}CategoryId:'
...
syn match ThorBodyInlineField '$\{0,1}Detection ID:'
syn match ThorBodyInlineField '$\{0,1}Detection Time:'
syn match ThorBodyInlineField '$\{0,1}Detection User:'
...
syn match ThorBodyInlineField '$\{0,1}Engine Version:'
syn match ThorBodyInlineField '$\{0,1}Error Code:'
syn match ThorBodyInlineField '$\{0,1}Error Description:'
...
syn match ThorBodyInlineField '$\{0,1}Execution ID:'
syn match ThorBodyInlineField '$\{0,1}Execution Name:'
...
syn match ThorBodyInlineField '$\{0,1}Origin ID:'
syn match ThorBodyInlineField '$\{0,1}Origin Name:'
...
syn match ThorBodyInlineField '$\{0,1}Post Clean Status:'
syn match ThorBodyInlineField '$\{0,1}Pre Execution Status:'
...
syn match ThorBodyInlineField '$\{0,1}Process Name:'
syn match ThorBodyInlineField '$\{0,1}Product:'
syn match ThorBodyInlineField '$\{0,1}Product Name:'
syn match ThorBodyInlineField '$\{0,1}Product Version:'
...
syn match ThorBodyInlineField '$\{0,1}Remediation User:'
...
syn match ThorBodyInlineField '$\{0,1}Security intelligence Version:'
...
syn match ThorBodyInlineField '$\{0,1}Severity ID:'
syn match ThorBodyInlineField '$\{0,1}Severity Name:'
syn match ThorBodyInlineField '$\{0,1}SidHistory:'
syn match ThorBodyInlineField '$\{0,1}Signature Version:'
...
syn match ThorBodyInlineField '$\{0,1}Source ID:'
syn match ThorBodyInlineField '$\{0,1}Source Name:'
syn match ThorBodyInlineField '$\{0,1}State:'
syn match ThorBodyInlineField '$\{0,1}Status:'
syn match ThorBodyInlineField '$\{0,1}Status Code:'
syn match ThorBodyInlineField '$\{0,1}Status Description:'
...
syn match ThorBodyInlineField '$\{0,1}Threat ID:'
syn match ThorBodyInlineField '$\{0,1}Threat Name:'
...
syn match ThorBodyInlineField '$\{0,1}Type ID:'
syn match ThorBodyInlineField '$\{0,1}Type Name:'
