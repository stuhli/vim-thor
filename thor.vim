...
syn match ThorImportant 'MESSAGE: And \d\+ more invalid License files found, use --printlicenses to print all licenses'
...
syn match ThorImportant "MESSAGE: Couldn't find any \S\+"
